(function (b) {
    ...
    b.extend(b.jgrid, {
        ...
        cellWidth: function () {
            var e = b("<div class='fg-jqgrid' style='left:10000px'><table class='fg-jqgrid-btable' style='width:5px;'><tr class='jqgrow'><td style='width:5px;display:block;'></td></tr></table></div>"),
        ...
        return this.each(function () {
            if (!this.grid) {
                var d = b.extend(!0, {
                    ...
                    userDataOnFooter: !1,
                    hoverrows: !0,
                    altclass: "fg-priority-secondary",
                    ...
                    groupingView: {
                        ...
                        summary: [],
                        summaryval: [],
                        plusicon: "fg-icon-circlesmall-plus",
                        minusicon: "fg-icon-circlesmall-minus",
                        displayField: [],
                        groupSummaryPos: [],
                        formatDisplayField: [],
                        _locgr: !1
                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var k = b("<div class='fg-jqgrid-view'></div>"),
                        n = b.jgrid.msie;
                        ...
                        var m = b("<div class='fg-jqgrid fg-widget fg-widget-content fg-corner-all'></div>");
                        b(m).attr({
                            id: "gbox_" + this.id,
                            dir: f
                        }).insertBefore(k);
                        b(k).attr("id", "gview_" + this.id).appendTo(m);
                        b("<div class='fg-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(k);
                        b("<div class='loading fg-state-default fg-state-active' id='load_" + this.id + "'>" + this.p.loadtext + "</div>").insertBefore(k);
                        b(this).attr({
                            cellspacing: "0",
                            cellpadding: "0",
                            border: "0",
                        ...
                        M = function (a, b, c, d) {
                            ...
                            return '<td role="gridcell" class="fg-state-default jqgrid-rownum" ' + p(a, b, c, null, b, !0) + ">" + c + "</td>"
                        },
                        ea = function (b) {
                            var c, d = [],
                            e = 0,
                        ...
                        $ = function (c, d, e, f, g, h) {
                            ...
                            m;
                            d = d ? "display:none;" : "";
                            e = "fg-widget-content jqgrow fg-row-" + a.p.direction + (e ? " " + e : "") + (h ? " fg-state-highlight" : "");
                        ...
                        P = function () {
                            ...
                            if (!a.p.hiddengrid) switch (a.p.loadui) {
                                case "enable":
                                    b("#load_" + b.jgrid.jqID(a.p.id)).next().find('.fg-jqgrid-bdiv').find("span").remove();
                                    break;
                                case "block":
                            ...
                            switch (a.p.loadui) {
                                case "enable":
                                        if (a.p.unwritten) {
                                            ...
                                            b("#load_" + c).next().find('.fg-jqgrid-bdiv').find(".unwritten").remove();
                                            var d = b("#load_" + c).next().find('.fg-jqgrid-bdiv').find('table tr').length;
                                            if (d == 1) {
                                                b("#load_" + c).next().find('.fg-jqgrid-bdiv').append('<div class="unwritten" style="text-align: center"><img src="/asset/img/no_data.png"></div>');
                                                b(a.p.pager).hide();
                                            }
                                            else {
                                                b(a.p.pager).show();
                        ...
                        qa = function (c, e) {
                            var d = "",
                            g = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='fg-pg-table'><tbody><tr>",
                            k = "",
                            ...
                            "rtl" === f && (g += k); !0 === a.p.pginput && (d = "<td dir='" + f + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='fg-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>") + "</td>"); !0 === a.p.pgbuttons ? (m = ["first" + e, "prev" + e, "next" + e, "last" + e], "rtl" === f && m.reverse(), g += "<td id='" + m[0] + "' class='fg-pg-button fg-corner-all'><span class='fg-icon-seek-first'><i class=\"fa fa-fast-backward\"></i></span></td>", g += "<td id='" + m[1] + "' class='fg-pg-button fg-corner-all'><span class='fg-icon-seek-prev'><i class=\"fa fa-backward\"></i></span></td>", g = g + ("" !== d ? "<td class='fg-pg-button fg-state-disabled' style='width:4px;'><span class='fg-separator'></span></td>" + d + "<td class='fg-pg-button fg-state-disabled' style='width:4px;'><span class='fg-separator'></span></td>" : "") + ("<td id='" + m[2] + "' class='fg-pg-button fg-corner-all'><span class='fg-icon-seek-next'><i class=\"fa fa-forward\"></i></span></td>"), g += "<td id='" + m[3] + "' class='fg-pg-button fg-corner-all'><span class='fg-icon-seek-end'><i class=\"fa fa-fast-forward\"></i></span></td>") : "" !== d && (g += d);
                            "ltr" === f && (g += k);
                            g += "</tr></tbody></table>"; !0 === a.p.viewrecords && b("td#" + c + "_" + a.p.recordpos, "#" + l).append("<div dir='" + f + "' style='text-align:left' class='fg-paging-info'></div>");
                            b("td#" + c + "_" + a.p.pagerpos, "#" + l).append(g);
                            k = b(".fg-jqgrid").css("font-size") || "11px";
                            b(document.body).append("<div id='testpg' class='fg-jqgrid fg-widget fg-widget-content' style='font-size:" + k + ";visibility:hidden;' ></div>");
                            ...
                            a.p._nvtd[1] = 0;
                            g = null;
                            b(".fg-pg-selbox", "#" + l).bind("change",
                            function () {
                                if (!q("records")) return !1;
                                a.p.page = Math.round(a.p.rowNum * (a.p.page - 1) / this.value - 0.5) + 1;
                                a.p.rowNum = this.value;
                                a.p.pager && b(".fg-pg-selbox", a.p.pager).val(this.value);
                                a.p.toppager && b(".fg-pg-selbox", a.p.toppager).val(this.value);
                                Q();
                                return !1
                            }); !0 === a.p.pgbuttons && (b(".fg-pg-button", "#" + l).hover(function () {
                                b(this).hasClass("fg-state-disabled") ? this.style.cursor = "default" : (b(this).addClass("fg-state-hover"), this.style.cursor = "pointer")
                            },
                            function () {
                                b(this).hasClass("fg-state-disabled") || (b(this).removeClass("fg-state-hover"), this.style.cursor = "default")
                            }), b("#first" + b.jgrid.jqID(e) + ", #prev" + b.jgrid.jqID(e) + ", #next" + b.jgrid.jqID(e) + ", #last" + b.jgrid.jqID(e)).click(function () {
                                if (b(this).hasClass("fg-state-disabled")) return !1;
                                var c = r(a.p.page, 1),
                                d = r(a.p.lastpage, 1),
                                g = !1,
                                f = !0,
                                ...
                                g && Q();
                                return !1
                            })); !0 === a.p.pginput && b("input.fg-pg-input", "#" + l).keypress(function (c) {
                        ...
                        wa = function (c, e) {
                            ...
                            var l = "";
                            b("span.fg-grid-ico-sort", k).addClass("fg-state-disabled");
                            ...
                            l ? (b("span.s-ico", k).show(), b("span.fg-icon-" + l, k).removeClass("fg-state-disabled"), b(k).attr("aria-selected", "true")) : a.p.viewsortcols[0] || b("span.s-ico", k).hide();
                            a.p.sortorder = "";
                            b.each(f,
                            function (b) {
                        ...
                        ra = function (c, d, e, g, f) {
                            if (a.p.colModel[d].sortable && !(0 < a.p.savedRow.length)) {
                                ...
                                if (a.p.multiSort) wa(d, f);
                                    ...
                                    b("span.fg-grid-ico-sort", e).addClass("fg-state-disabled");
                                    b(e).attr("aria-selected", "false");
                                    a.p.frozenColumns && (a.grid.fhDiv.find("span.fg-grid-ico-sort").addClass("fg-state-disabled"), a.grid.fhDiv.find("th").attr("aria-selected", "false"));
                                    b("span.fg-icon-" + a.p.sortorder, f).removeClass("fg-state-disabled");
                        ...
                        a.p.data.length && O();
                        var D = "<thead><tr class='fg-jqgrid-labels' role='rowheader'>",
                        ...
                        "horizontal" === a.p.viewsortcols[1] && (ba = " fg-i-asc", ua = " fg-i-desc");
                        ta = n ? "class='fg-th-div-ie'" : "";
                        ba = "<span class='s-ico' style='display:none'><span sort='asc' class='fg-grid-ico-sort fg-icon-asc" + ba + " fg-state-disabled fg-icon fg-icon-triangle-1-n fg-sort-" + f + "'></span>" + ("<span sort='desc' class='fg-grid-ico-sort fg-icon-desc" + ua + " fg-state-disabled fg-icon fg-icon-triangle-1-s fg-sort-" + f + "'></span></span>");
                        ...
                        for (g = 0; g < this.p.colNames.length; g++) {
                            ...
                            D += "<th id='" + a.p.id + "_" + a.p.colModel[g].name + "' style='text-align:" + a.p.colModel[g].align + ";' role='columnheader' class='fg-state-default fg-th-column fg-th-" + f + "'" + F + ">",
                        ...
                        function () {
                            b(this).removeClass("fg-state-hover")
                        });
                        if (this.p.multiselect) {
                            ...
                            function () {
                                ...
                                this.checked ? (b(a.rows).each(function (d) {
                                    0 < d && !b(this).hasClass("fg-subgrid") && !b(this).hasClass("jqgroup") && !b(this).hasClass("fg-state-disabled") && (b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop" : "attr"]("checked", !0), b(this).addClass("fg-state-highlight").attr("aria-selected", "true"), a.p.selarrrow.push(this.id), a.p.selrow = this.id, c && (b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id), a.grid.fbDiv)[a.p.useProp ? "prop" : "attr"]("checked", !0), b("#" + b.jgrid.jqID(this.id), a.grid.fbDiv).addClass("fg-state-highlight")))
                                }), ca = !0, bd = []) : (b(a.rows).each(function (d) {
                                    0 < d && !b(this).hasClass("fg-subgrid") && !b(this).hasClass("fg-state-disabled") && (b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id))[a.p.useProp ? "prop" : "attr"]("checked", !1), b(this).removeClass("fg-state-highlight").attr("aria-selected", "false"), bd.push(this.id), c && (b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(this.id), a.grid.fbDiv)[a.p.useProp ? "prop" : "attr"]("checked", !1), b("#" + b.jgrid.jqID(this.id), a.grid.fbDiv).removeClass("fg-state-highlight")))
                        ...
                        b(m).css("width", c.width + "px").append("<div class='fg-jqgrid-resize-mark' id='rs_m" + a.p.id + "'>&#160;</div>");
                        b(k).css("width", c.width + "px");
                        var D = b("thead:first", a).get(0),
                        V = "";
                        a.p.footerrow && (V += "<table role='grid' style='width:" + a.p.tblwidth + "px' class='fg-jqgrid-ftable' cellspacing='0' cellpadding='0' border='0'><tbody><tr role='row' class='fg-widget-content footrow footrow-" + f + "'>");
                        var k = b("tr:first", D),
                        ...
                        b("th", k).each(function (d) {
                            ...
                            a.p.colModel[d].resizable ? (fa = document.createElement("span"), b(fa).html("&#160;").addClass("fg-jqgrid-resize fg-jqgrid-resize-" + f).css("cursor", "col-resize"), b(this).addClass(a.p.resizeclass)) : fa = "";
                            ...
                            "cb" !== e && "subgrid" !== e && "rn" !== e && a.p.viewsortcols[2] && b(">div", this).addClass("fg-jqgrid-sortable");
                            ka && (a.p.multiSort ? a.p.viewsortcols[0] ? (b("div span.s-ico", this).show(), a.p.colModel[d].lso && b("div span.fg-icon-" + a.p.colModel[d].lso, this).removeClass("fg-state-disabled")) : a.p.colModel[d].lso && (b("div span.s-ico", this).show(), b("div span.fg-icon-" + a.p.colModel[d].lso, this).removeClass("fg-state-disabled")) : a.p.viewsortcols[0] ? (b("div span.s-ico", this).show(), d === a.p.lastsort && b("div span.fg-icon-" + a.p.sortorder, this).removeClass("fg-state-disabled")) : d === a.p.lastsort && (b("div span.s-ico", this).show(), b("div span.fg-icon-" + a.p.sortorder, this).removeClass("fg-state-disabled")));
                            a.p.footerrow && (V += "<td role='gridcell' " + p(d, 0, "", null, "", !1) + ">&#160;</td>")
                        }).mousedown(function (d) {
                            if (1 === b(d.target).closest("th>span.fg-jqgrid-resize").length) {
                                var e = sa(this);
                                if (!0 === a.p.forceFit) {
                                    var g = a.p,
                                    f = e,
                            ...
                            var d = "th>div.fg-jqgrid-sortable",
                            e, g;
                            a.p.viewsortcols[2] || (d = "th>div>span>span.fg-grid-ico-sort");
                        ...
                        this.appendChild(k);
                        b(this).addClass("fg-jqgrid-btable").append(be);
                        var be = null,
                        k = b("<table class='fg-jqgrid-htable' style='width:" + a.p.tblwidth + "px' role='grid' aria-labelledby='gbox_" + this.id + "' cellspacing='0' cellpadding='0' border='0'></table>").append(D),
                        J = a.p.caption && !0 === a.p.hiddengrid ? !0 : !1;
                        g = b("<div class='fg-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'><div class='edit_items' title='编辑显示字段'>...</div></div>");
                        D = null;
                        c.hDiv = document.createElement("div");
                        b(c.hDiv).css({
                            width: c.width + "px"
                        }).addClass("fg-state-default fg-jqgrid-hdiv").append(g);
                        b(g).append(k);
                        k = null;
                        J && b(c.hDiv).hide();
                        a.p.pager && ("string" === typeof a.p.pager ? "#" !== a.p.pager.substr(0, 1) && (a.p.pager = "#" + a.p.pager) : a.p.pager = "#" + b(a.p.pager).attr("id"), b(a.p.pager).css({
                            width: c.width + "px"
                        }).addClass("fg-state-default fg-jqgrid-pager fg-corner-bottom").appendTo(m), J && b(a.p.pager).hide(), qa(a.p.pager, "")); !1 === a.p.cellEdit && !0 === a.p.hoverrows && b(a).bind("mouseover",
                        function (a) {
                            t = b(a.target).closest("tr.jqgrow");
                            "fg-subgrid" !== b(t).attr("class") && b(t).addClass("fg-state-hover")
                        }).bind("mouseout",
                        function (a) {
                            t = b(a.target).closest("tr.jqgrow");
                            b(t).removeClass("fg-state-hover")
                        });
                        var B, N, ma;
                        b(a).before(c.hDiv).click(function (c) {
                            y = c.target;
                            t = b(y, a.rows).closest("tr.jqgrow");
                            if (0 === b(t).length || -1 < t[0].className.indexOf("fg-state-disabled") || (b(y, a).closest("table.fg-jqgrid-btable").attr("id") || "").replace("_frozen", "") !== a.id) return this;
                            ...
                            if ("A" !== y.tagName && ("INPUT" !== y.tagName && "TEXTAREA" !== y.tagName && "OPTION" !== y.tagName && "SELECT" !== y.tagName || d) && !0 === e) if (B = t[0].id, N = b.jgrid.getCellIndex(y), ma = b(y).closest("td,th").html(), b(a).triggerHandler("jqGridCellSelect", [B, N, ma, c]), b.isFunction(a.p.onCellSelect) && a.p.onCellSelect.call(a, B, N, ma, c), !0 === a.p.cellEdit) if (a.p.multiselect && d) b(a).jqGrid("setSelection", B, !0, c);
                                ...
                                if (a.p.multiselect && a.p.multiboxonly && !d) {
                                    ...
                                    b(a.p.selarrrow).each(function (c, d) {
                                        ...
                                        b(e).removeClass("fg-state-highlight");
                                        b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(d))[a.p.useProp ? "prop" : "attr"]("checked", !1);
                                        f && (b("#" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(f)).removeClass("fg-state-highlight"), b("#jqg_" + b.jgrid.jqID(a.p.id) + "_" + b.jgrid.jqID(d), "#" + b.jgrid.jqID(f))[a.p.useProp ? "prop" : "attr"]("checked", !1))
                                    });
                                    a.p.selarrrow = []
                                }
                        ...
                        function (c, d) {
                            ...
                            y = c.target;
                            t = b(y, a.rows).closest("tr.jqgrow");
                            0 !== b(t).length && (B = t[0].rowIndex, N = b.jgrid.getCellIndex(y),
                            b(a).triggerHandler("jqGridDblClickRow", [b(t).attr("id"), B, N, c]), b.isFunction(a.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(t).attr("id"), B, N, c))
                        }).bind("contextmenu", function (t) {
                            if (c = t.target, h = b(c, a.rows).closest("tr.jqgrow"), 0 !== b(h).length) {
                                a.p.multiselect || b(a).jqGrid("setSelection", h[0].id, !0, t);
                                l = h[0].rowIndex;
                                N = b.jgrid.getCellIndex(c);
                                var r = b(a).triggerHandler("jqGridRightClickRow", [b(h).attr("id"), l, b, t]);
                                return null != r ? r : b.isFunction(a.p.onRightClickRow) && (r = a.p.onRightClickRow.call(a,b(h).attr("id"), l, b, t), null != r) ? r : void 0
                            }
                        }),
                        c.bDiv = document.createElement("div");
                        n && "auto" === String(a.p.height).toLowerCase() && (a.p.height = "100%");
                        b(c.bDiv).append(b('<div style="position:relative;' + (n && 8 > b.jgrid.msiever() ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("fg-jqgrid-bdiv").css({
                        ...
                        var bf = !0 === a.p.hidegrid ? b("<a role='link' class='fg-jqgrid-titlebar-close fg-corner-all HeaderButton' />").hover(function () {
                            bf.addClass("fg-state-hover")
                        },
                        function () {
                            bf.removeClass("fg-state-hover")
                        }).append("<span class='fg-icon fg-icon-circle-triangle-n'></span>").css("rtl" === f ? "left" : "right", "0px") : "";
                        b(c.cDiv).append(bf).append("<span class='fg-jqgrid-title'>" + a.p.caption + "</span>").addClass("fg-jqgrid-titlebar fg-jqgrid-caption" + ("rtl" === f ? "-rtl" : "") + " fg-widget-header fg-corner-top fg-helper-clearfix");
                        b(c.cDiv).insertBefore(c.hDiv);
                        a.p.fgtoolbar[0] && (c.uDiv = document.createElement("div"), "top" === a.p.fgtoolbar[1] ? b(c.uDiv).insertBefore(c.hDiv) : "bottom" === a.p.fgtoolbar[1] && b(c.uDiv).insertAfter(c.hDiv), "both" === a.p.fgtoolbar[1] ? (c.ubDiv = document.createElement("div"), b(c.uDiv).addClass("fg-userdata fg-state-default").attr("id", "t_" + this.id).insertBefore(c.hDiv), b(c.ubDiv).addClass("fg-userdata fg-state-default").attr("id", "tb_" + this.id).insertAfter(c.hDiv), J && b(c.ubDiv).hide()) : b(c.uDiv).width(c.width).addClass("fg-userdata fg-state-default").attr("id", "t_" + this.id), J && b(c.uDiv).hide());
                        a.p.toppager && (a.p.toppager = b.jgrid.jqID(a.p.id) + "_toppager", c.topDiv = b("<div id='" + a.p.toppager + "'></div>")[0], a.p.toppager = "#" + a.p.toppager, b(c.topDiv).addClass("fg-state-default fg-jqgrid-toppager").width(c.width).insertBefore(c.hDiv), qa(a.p.toppager, "_t"));
                        a.p.footerrow && (c.sDiv = b("<div class='fg-jqgrid-sdiv'></div>")[0], g = b("<div class='fg-jqgrid-hbox" + ("rtl" === f ? "-rtl" : "") + "'></div>"), b(c.sDiv).append(g).width(c.width).insertAfter(c.hDiv), b(g).append(V), c.footers = b(".fg-jqgrid-ftable", c.sDiv)[0].rows[0].cells, a.p.rownumbers && (c.footers[0].className = "fg-state-default jqgrid-rownum"), J && b(c.sDiv).hide());
                        g = null;
                        if (a.p.caption) {
                            var bg = a.p.datatype; !0 === a.p.hidegrid && (b(".fg-jqgrid-titlebar-close", c.cDiv).click(function (d) {
                                var e = b.isFunction(a.p.onHeaderClick),
                                g = ".fg-jqgrid-bdiv, .fg-jqgrid-hdiv, .fg-jqgrid-pager, .fg-jqgrid-sdiv",
                                f,
                                h = this; !0 === a.p.fgtoolbar[0] && ("both" === a.p.fgtoolbar[1] && (g += ", #" + b(c.ubDiv).attr("id")), g += ", #" + b(c.uDiv).attr("id"));
                                f = b(g, "#gview_" + b.jgrid.jqID(a.p.id)).length;
                                "visible" === a.p.gridstate ? b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideUp("fast",
                                function () {
                                    f--;
                                    0 === f && (b("span", h).removeClass("fg-icon-circle-triangle-n").addClass("fg-icon-circle-triangle-s"), a.p.gridstate = "hidden", b("#gbox_" + b.jgrid.jqID(a.p.id)).hasClass("fg-resizable") && b(".fg-resizable-handle", "#gbox_" + b.jgrid.jqID(a.p.id)).hide(), b(a).triggerHandler("jqGridHeaderClick", [a.p.gridstate, d]), e && (J || a.p.onHeaderClick.call(a, a.p.gridstate, d)))
                                }) : "hidden" === a.p.gridstate && b(g, "#gbox_" + b.jgrid.jqID(a.p.id)).slideDown("fast",
                                function () {
                                    f--;
                                    0 === f && (b("span", h).removeClass("fg-icon-circle-triangle-s").addClass("fg-icon-circle-triangle-n"), J && (a.p.datatype = bg, Q(), J = !1), a.p.gridstate = "visible", b("#gbox_" + b.jgrid.jqID(a.p.id)).hasClass("fg-resizable") && b(".fg-resizable-handle", "#gbox_" + b.jgrid.jqID(a.p.id)).show(), b(a).triggerHandler("jqGridHeaderClick", [a.p.gridstate, d]), e && (J || a.p.onHeaderClick.call(a, a.p.gridstate, d)))
                                });
                                return !1
                            }), J && (a.p.datatype = "local", b(".fg-jqgrid-titlebar-close", c.cDiv).trigger("click")))
                        } else b(c.cDiv).hide();
                        b(c.hDiv).after(c.bDiv).mousemove(function (a) {
                            if (c.resizing) return c.dragMove(a),
                            !1
                        });
                        b(".fg-jqgrid-labels", c.hDiv).bind("selectstart",
                        function () {
                            return !1
                        });
                        ...
                        a.updatepager = function (c, d) {
                            ...
                            !0 === a.p.pginput && (b(".fg-pg-input", n).val(a.p.page), h = a.p.toppager ? "#sp_1" + p + ",#sp_1" + q : "#sp_1" + p, b(h).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage, m) : a.p.lastpage)),
                            a.p.viewrecords && (0 === a.p.reccount ? b(".fg-paging-info", n).html(a.p.emptyrecords) : (h = f + 1, l = a.p.records, b.fmatter && (h = b.fmatter.util.NumberFormat(h, m), k = b.fmatter.util.NumberFormat(k, m), l = b.fmatter.util.NumberFormat(l, m)), b(".fg-paging-info", n).html(b.jgrid.format(a.p.recordtext,l.replace(/ /g, ''))))),
                            !0 === a.p.pgbuttons && (0 >= e && (e = g = 0), 1 === e || 0 === e ? (b("#first" + p + ", #prev" + p).addClass("fg-state-disabled").removeClass("fg-state-hover"), a.p.toppager && b("#first_t" + q + ", #prev_t" + q).addClass("fg-state-disabled").removeClass("fg-state-hover")) : (b("#first" + p + ", #prev" + p).removeClass("fg-state-disabled"), a.p.toppager && b("#first_t" + q + ", #prev_t" + q).removeClass("fg-state-disabled")), e === g || 0 === e ? (b("#next" + p + ", #last" + p).addClass("fg-state-disabled").removeClass("fg-state-hover"), a.p.toppager && b("#next_t" + q + ", #last_t" + q).addClass("fg-state-disabled").removeClass("fg-state-hover")) : (b("#next" + p + ", #last" + p).removeClass("fg-state-disabled"), a.p.toppager && b("#next_t" + q + ", #last_t" + q).removeClass("fg-state-disabled"))); !0 === c && !0 === a.p.rownumbers && b(">td.jqgrid-rownum", a.rows).each(function (a) {
                                b(this).html(f + 1 + a)
                            });
    ...
    b.jgrid.extend({
        ...
        setSelection: function (e, f, c) {
            return this.each(function () {
                var d, a, l, g, h, k;
                void 0 !== e && (f = !1 === f ? !1 : !0, !(a = b(this).jqGrid("getGridRowById", e)) || !a.className || -1 < a.className.indexOf("fg-state-disabled") || (!0 === this.p.scrollrows && (l = b(this).jqGrid("getGridRowById", e).rowIndex, 0 <= l && (d = b(this.grid.bDiv)[0].clientHeight, g = b(this.grid.bDiv)[0].scrollTop, h = b(this.rows[l]).position().top, l = this.rows[l].clientHeight, h + l >= d + g ? b(this.grid.bDiv)[0].scrollTop = h - (d + g) + l + g : h < d + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))), !0 === this.p.frozenColumns && (k = this.p.id + "_frozen"), this.p.multiselect ? (this.setHeadCheckBox(!1), this.p.selrow = a.id, g = b.inArray(this.p.selrow, this.p.selarrrow), -1 === g ? ("fg-subgrid" !== a.className && b(a).addClass("fg-state-highlight").attr("aria-selected", "true"), d = !0, this.p.selarrrow.push(this.p.selrow)) : ("fg-subgrid" !== a.className && b(a).removeClass("fg-state-highlight").attr("aria-selected", "false"), d = !1, this.p.selarrrow.splice(g, 1), h = this.p.selarrrow[0], this.p.selrow = void 0 === h ? null : h), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(a.id))[this.p.useProp ? "prop" : "attr"]("checked", d), k && (-1 === g ? b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(k)).addClass("fg-state-highlight") : b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(k)).removeClass("fg-state-highlight"), b("#jqg_" + b.jgrid.jqID(this.p.id) + "_" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(k))[this.p.useProp ? "prop" : "attr"]("checked", d)), f && (b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, d, c))) : "fg-subgrid" !== a.className && (this.p.selrow !== a.id ? (b(b(this).jqGrid("getGridRowById", this.p.selrow)).removeClass("fg-state-highlight").attr({
                    "aria-selected": "false",
                    tabindex: "-1"
                }), b(a).addClass("fg-state-highlight").attr({
                    "aria-selected": "true",
                    tabindex: "0"
                }), k && (b("#" + b.jgrid.jqID(this.p.selrow), "#" + b.jgrid.jqID(k)).removeClass("fg-state-highlight"), b("#" + b.jgrid.jqID(e), "#" + b.jgrid.jqID(k)).addClass("fg-state-highlight")), d = !0) : d = !1, this.p.selrow = a.id, f && (b(this).triggerHandler("jqGridSelectRow", [a.id, d, c]), this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, d, c)))))
            })
        },
        resetSelection: function (e) {
            return this.each(function () {
                ...
                if (void 0 !== e) {
                    ...
                    b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#" + b.jgrid.jqID(c)).removeClass("fg-state-highlight").attr("aria-selected", "false");
                    d && b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d)).removeClass("fg-state-highlight");
                    if (f.p.multiselect) {
                    ...
                    b(b(f).jqGrid("getGridRowById", c)).removeClass("fg-state-highlight").attr("aria-selected", "false");
                    b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(c))[f.p.useProp ? "prop" : "attr"]("checked", !1);
                    d && (b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d)).removeClass("fg-state-highlight"), b("#jqg_" + b.jgrid.jqID(f.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d))[f.p.useProp ? "prop" : "attr"]("checked", !1))
                }), f.setHeadCheckBox(!1), f.p.selarrrow = [], f.p.selrow = null) : f.p.selrow && (b("#" + b.jgrid.jqID(f.p.id) + " tbody:first tr#" + b.jgrid.jqID(f.p.selrow)).removeClass("fg-state-highlight").attr("aria-selected", "false"), d && b("#" + b.jgrid.jqID(f.p.selrow), "#" + b.jgrid.jqID(d)).removeClass("fg-state-highlight"), f.p.selrow = null); !0 === f.p.cellEdit && 0 <= parseInt(f.p.iCol, 10) && 0 <= parseInt(f.p.iRow, 10) && (b("td:eq(" + f.p.iCol + ")", f.rows[f.p.iRow]).removeClass("edit-cell fg-state-highlight"), b(f.rows[f.p.iRow]).removeClass("selected-row fg-state-hover"));
                f.p.savedRow = []
            })
        },
        ...
        addRowData: function (e, f, c, d) {
            ...
            f && (b.isArray(f) ? (x = !0, c = "last", G = e) : (f = [f], x = !1), this.each(function () {
                ...
                Y = b.isFunction(this.p.afterInsertRow) ? !0 : !1; O < X;) {
                    ...
                    W = e;
                    e = this.p.idPrefix + e;
                    n && (q = this.formatCol(0, 1, "", null, e, !0), g[g.length] = '<td role="gridcell" class="fg-state-default jqgrid-rownum" ' + q + ">0</td>");
                    ...
                    if (0 === this.rows.length) b("table:first", this.grid.bDiv).append(g.join(""));
                        ...
                        case "first":
                            ...
                            break;
                        case "after":
                            if (m = b(this).jqGrid("getGridRowById", d)) b(this.rows[m.rowIndex + 1]).hasClass("fg-subgrid") ? b(this.rows[m.rowIndex + 1]).after(g) : b(m).after(g.join("")),
                            m = m.rowIndex + 1;
                            break;
                        case "before":
        ...
        remapColumns: function (e, f, c) {
            ...
            d(l.p.colNames);
            d(l.grid.headers);
            a(b("thead:first", l.grid.hDiv), c && ":not(.fg-jqgrid-labels)");
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (!isNaN(e)) {
                        ...
                        c.p.toppager && b(c.p.toppager).css("width", e + "px"); !0 === c.p.fgtoolbar[0] && (b(c.grid.uDiv).css("width", e + "px"), "both" === c.p.fgtoolbar[1] && b(c.grid.ubDiv).css("width", e + "px"));
        ...
        setCaption: function (e) {
            return this.each(function () {
                this.p.caption = e;
                b("span.fg-jqgrid-title, span.fg-jqgrid-title-rtl", this.grid.cDiv).html(e);
        ...
        setLabel: function (e, f, c, d) {
            return this.each(function () {
                ...
                if (this.grid && void 0 !== e && (b(this.p.colModel).each(function (b) {
                    ...
                    var l = b("tr.fg-jqgrid-labels th:eq(" + a + ")", this.grid.hDiv);
                    if (f) {
                        var g = b(".s-ico", l);
        ...
        clearGridData: function (e) {
            return this.each(function () {
                if (this.grid) {
                    ...
                    this.p.footerrow && e && b(".fg-jqgrid-ftable td", this.grid.sDiv).html("&#160;");
                    this.p.selrow = null;
                    this.p.selarrrow = [];
                    this.p.savedRow = [];
                    this.p.records = 0;
    ...
    a.fn.fmatter.rowactions = function (c) {
        ...
        d = b.attr("id"),
        e = a(this).closest("table.fg-jqgrid-btable").attr("id").replace(/_frozen([^_]*)$/, "$1"),
        e = a("#" + e),
        f = e[0],
        g = f.p,
        ...
        m = function (b) {
            ...
            l.find("div.fg-inline-edit,div.fg-inline-del").show();
            l.find("div.fg-inline-save,div.fg-inline-cancel").hide()
        };
        ...
        switch (c) {
            case "edit":
                ...
                l.find("div.fg-inline-edit,div.fg-inline-del").hide();
                l.find("div.fg-inline-save,div.fg-inline-cancel").show();
                e.triggerHandler("jqGridAfterGridComplete");
                break;
            case "save":
                e.jqGrid("saveRow", d, b) && (l.find("div.fg-inline-edit,div.fg-inline-del").show(), l.find("div.fg-inline-save,div.fg-inline-cancel").hide(), e.triggerHandler("jqGridAfterGridComplete"));
                break;
            case "cancel":
    ...
    a.fn.fmatter.actions = function (c, b) {
        ...
        d.editformbutton ? f += "<div title='" + a.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='fg-pg-div fg-inline-edit' " + ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'formedit'); onmouseover=jQuery(this).addClass('fg-state-hover'); onmouseout=jQuery(this).removeClass('fg-state-hover'); ") + "><span class='fg-icon fg-icon-pencil'></span></div>" : d.editbutton && (f += "<div title='" + a.jgrid.nav.edittitle + "' style='float:left;cursor:pointer;' class='fg-pg-div fg-inline-edit' " + ("id='jEditButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'edit'); onmouseover=jQuery(this).addClass('fg-state-hover'); onmouseout=jQuery(this).removeClass('fg-state-hover') ") + "><span class='fg-icon fg-icon-pencil'></span></div>");
        d.delbutton && (f += "<div title='" + a.jgrid.nav.deltitle + "' style='float:left;margin-left:5px;' class='fg-pg-div fg-inline-del' " + ("id='jDeleteButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'del'); onmouseover=jQuery(this).addClass('fg-state-hover'); onmouseout=jQuery(this).removeClass('fg-state-hover'); ") + "><span class='fg-icon fg-icon-trash'></span></div>");
        f += "<div title='" + a.jgrid.edit.bSubmit + "' style='float:left;display:none' class='fg-pg-div fg-inline-save' " + ("id='jSaveButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'save'); onmouseover=jQuery(this).addClass('fg-state-hover'); onmouseout=jQuery(this).removeClass('fg-state-hover'); ") + "><span class='fg-icon fg-icon-disk'></span></div>";
        f += "<div title='" + a.jgrid.edit.bCancel + "' style='float:left;display:none;margin-left:5px;' class='fg-pg-div fg-inline-cancel' " + ("id='jCancelButton_" + e + "' onclick=jQuery.fn.fmatter.rowactions.call(this,'cancel'); onmouseover=jQuery(this).addClass('fg-state-hover'); onmouseout=jQuery(this).removeClass('fg-state-hover'); ") + "><span class='fg-icon fg-icon-cancel'></span></div>";
    ...
    a.jgrid.extend({
        ...
        GridUnload: function () {
            return this.each(function () {
                if (this.grid) {
                    ...
                    c = a(this).attr("class");
                    this.p.pager && a(this.p.pager).empty().removeClass("fg-state-default fg-jqgrid-pager fg-corner-bottom");
                    ...
                    a(d).removeClass("fg-jqgrid-btable");
        ...
        setGridState: function (b) {
            return this.each(function () {
                this.grid && ("hidden" === b ? (a(".fg-jqgrid-bdiv, .fg-jqgrid-hdiv", "#gview_" + a.jgrid.jqID(this.p.id)).slideUp("fast"), this.p.pager && a(this.p.pager).slideUp("fast"), this.p.toppager && a(this.p.toppager).slideUp("fast"), !0 === this.p.fgtoolbar[0] && ("both" === this.p.fgtoolbar[1] && a(this.grid.ubDiv).slideUp("fast"), a(this.grid.uDiv).slideUp("fast")), this.p.footerrow && a(".fg-jqgrid-sdiv", "#gbox_" + a.jgrid.jqID(this.p.id)).slideUp("fast"), a(".fg-jqgrid-titlebar-close span", this.grid.cDiv).removeClass("fg-icon-circle-triangle-n").addClass("fg-icon-circle-triangle-s"), this.p.gridstate = "hidden") : "visible" === b && (a(".fg-jqgrid-hdiv, .fg-jqgrid-bdiv", "#gview_" + a.jgrid.jqID(this.p.id)).slideDown("fast"), this.p.pager && a(this.p.pager).slideDown("fast"), this.p.toppager && a(this.p.toppager).slideDown("fast"), !0 === this.p.fgtoolbar[0] && ("both" === this.p.fgtoolbar[1] && a(this.grid.ubDiv).slideDown("fast"), a(this.grid.uDiv).slideDown("fast")), this.p.footerrow && a(".fg-jqgrid-sdiv", "#gbox_" + a.jgrid.jqID(this.p.id)).slideDown("fast"), a(".fg-jqgrid-titlebar-close span", this.grid.cDiv).removeClass("fg-icon-circle-triangle-s").addClass("fg-icon-circle-triangle-n"), this.p.gridstate = "visible"))
            })
        },
            ...
            return this.each(function () {
                ...
                if (!this.fgtoolbar) {
                    ...
                    h = function (e, f, g) {
                        ...
                        f = parseInt(f, 10);
                        g = parseInt(g, 10) + 18;
                        f = '<ul id="sopt_menu" class="fg-search-menu" role="menu" tabindex="0" style="font-size:' + (a(".fg-jqgrid-view").css("font-size") || "11px") + ";left:" + f + "px;top:" + g + 'px;">';
                        g = a(e).attr("soper");
                        var k, h = [],
                        q,
                        p = 0,
                        ...
                        -1 !== q && (k = g === b.odata[q].oper ? "fg-state-highlight" : "", f += '<li class="fg-menu-item ' + k + '" role="presentation"><a class="fg-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[q].oper + '" oper="' + b.operands[b.odata[q].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' + b.operands[b.odata[q].oper] + "</td><td>" + b.odata[q].text + "</td></tr></table></a></li>");
                        f += "</ul>";
                        a("body").append(f);
                        a("#sopt_menu").addClass("fg-menu fg-widget fg-widget-content fg-corner-all");
                        a("#sopt_menu > li > a").hover(function () {
                            a(this).addClass("fg-state-hover")
                        },
                        function () {
                            a(this).removeClass("fg-state-hover")
                        }).click(function (f) {
                            f = a(this).attr("value");
                    ...
                    k = a("<tr class='fg-search-fgtoolbar' role='rowheader'></tr>"),
                    e;
                    a.each(c.p.colModel,
                    function (h) {
                        var f = this,
                        ...
                        m = "";
                        var x = "=",
                        q, p = a("<th role='columnheader' class='fg-state-default fg-th-column fg-th-" + c.p.direction + "'></th>"),
                        l = a("<div style='position:relative;height:100%;padding-right:0.3em;padding-left:0.3em;'></div>"),
                        n = a("<table class='fg-search-table' cellspacing='0'><tr><td class='fg-search-oper'></td><td class='fg-search-input'></td><td class='fg-search-clear'></td></tr></table>"); !0 === this.hidden && a(p).css("display", "none");
                    ...
                    a(".clearsearchclass", k).click(function (e) {
                        ...
                        var f = parseInt(a("td.fg-search-oper", e).attr("colindex"), 10),
                        g = a.extend({},
                        c.p.colModel[f].searchoptions || {}),
                        g = g.defaultValue ? g.defaultValue : "";
                        "select" === c.p.colModel[f].stype ? g ? a("td.fg-search-input select", e).val(g) : a("td.fg-search-input select", e)[0].selectedIndex = 0 : a("td.fg-search-input input", e).val(g); !0 === b.autosearch && d()
                    });
                    this.fgtoolbar = !0;
                    ...
                    this.toggleToolbar = function () {
                        var b = a("tr.fg-search-fgtoolbar", c.grid.hDiv),
                        d = !0 === c.p.frozenColumns ? a("tr.fg-search-fgtoolbar", c.grid.fhDiv) : !1;
        ...
        destroyFilterToolbar: function () {
            return this.each(function () {
                this.fgtoolbar && (this.toggleToolbar = this.clearToolbar = this.triggerToolbar = null, this.fgtoolbar = !1, a(this.grid.hDiv).find("table thead tr.fg-search-fgtoolbar").remove())
            })
        },
        destroyGroupHeader: function (b) {
            ...
            return this.each(function () {
                var c, d, h, k, e, s;
                d = this.grid;
                var f = a("table.fg-jqgrid-htable thead", d.hDiv),
                g = this.p.colModel;
                if (d) {
                    a(this).unbind(".setGroupHeaders");
                    c = a("<tr>", {
                        role: "rowheader"
                    }).addClass("fg-jqgrid-labels");
                    k = d.headers;
                    d = 0;
                    for (h = k.length; d < h; d++) {
                        ...
                        c.append(e);
                        s = e.children("span.fg-jqgrid-resize");
                        0 < s.length && (s[0].style.height = "");
                        e.children("div")[0].style.top = ""
                    }
                    a(f).children("tr.fg-jqgrid-labels").remove();
        ...
        setGroupHeaders: function (b) {
            ...
            return this.each(function () {
                ...
                x = m.length,
                q = this.grid.headers,
                p = a("table.fg-jqgrid-htable", this.grid.hDiv),
                l = p.children("thead").children("tr.fg-jqgrid-labels:last").addClass("jqg-second-row-header");
                k = p.children("thead");
                ...
                k = a("<tr>", {
                    role: "rowheader"
                }).addClass("fg-jqgrid-labels jqg-third-row-header");
                ...
                a("<th>", {
                    role: "gridcell"
                }).css(e).addClass("fg-first-th-" + this.p.direction).appendTo(n), s.style.width = "", e = w(d.name, b.groupHeaders), 0 <= e) {
                    e = b.groupHeaders[e];
                    h = e.numberOfColumns;
                    g = e.titleText;
                    ...
                    e = a("<th>").attr({
                        role: "columnheader"
                    }).addClass("fg-state-default fg-th-column-header fg-th-" + this.p.direction).css({
                        height: "28px",
                        "border-top": "0 none"
                    }).html(g);
                ...
                k.insertAfter(l);
                p.append(m);
                b.useColSpanStyle && (p.find("span.fg-jqgrid-resize").each(function () {
                    var b = a(this).parent();
                    b.is(":visible") && (this.style.cssText = "height: " + b.height() + "px !important; cursor: col-resize;")
                }), p.find("div.fg-jqgrid-sortable").each(function () {
                    var b = a(this),
                    c = b.parent();
                    c.is(":visible") && c.is(":has(span.fg-jqgrid-resize)") && b.css("top", (c.height() - b.outerHeight()) / 2 - 2 + "px")
                }));
                ...
                if (this.grid) {
                    ...
                    if (!0 !== b.p.subGrid && !0 !== b.p.treeGrid && !0 !== b.p.cellEdit && !b.p.sortable && !b.p.scroll) {
                        ...
                        if (0 <= k && e) {
                            ...
                            d = a(".fg-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).height();
                            b.p.toppager && (c += a(b.grid.topDiv).outerHeight()); !0 === b.p.fgtoolbar[0] && "bottom" !== b.p.fgtoolbar[1] && (c += a(b.grid.uDiv).outerHeight());
                            b.grid.fhDiv = a('<div style="position:absolute;left:0px;top:' + c + "px;height:" + d + 'px;" class="frozen-div fg-state-default fg-jqgrid-hdiv"></div>');
                            b.grid.fbDiv = a('<div style="position:absolute;left:0px;top:' + (parseInt(c, 10) + parseInt(d, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv fg-jqgrid-bdiv"></div>');
                            a("#gview_" + a.jgrid.jqID(b.p.id)).append(b.grid.fhDiv);
                            c = a(".fg-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).clone(!0);
                            if (b.p.groupHeader) {
                            ...
                            function (c, d, e) {
                                c = a(".fg-jqgrid-htable", b.grid.fhDiv);
                                a("th:eq(" + e + ")", c).width(d);
                                c = a(".fg-jqgrid-btable", b.grid.fbDiv);
                                a("tr:first td:eq(" + e + ")", c).width(d)
                            });
                            a(b).bind("jqGridSortCol.setFrozenColumns",
                            function (c, d, e) {
                                c = a("tr.fg-jqgrid-labels:last th:eq(" + b.p.lastsort + ")", b.grid.fhDiv);
                                d = a("tr.fg-jqgrid-labels:last th:eq(" + e + ")", b.grid.fhDiv);
                                a("span.fg-grid-ico-sort", c).addClass("fg-state-disabled");
                                a(c).attr("aria-selected", "false");
                                a("span.fg-icon-" + b.p.sortorder, d).removeClass("fg-state-disabled");
                            ...
                            function () {
                                ...
                                a(b.grid.fbDiv).append(c); !0 === b.p.hoverrows && (a("tr.jqgrow", c).hover(function () {
                                    a(this).addClass("fg-state-hover");
                                    a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id)).addClass("fg-state-hover")
                                },
                                function () {
                                    a(this).removeClass("fg-state-hover");
                                    a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id)).removeClass("fg-state-hover")
                                }), a("tr.jqgrow", "#" + a.jgrid.jqID(b.p.id)).hover(function () {
                                    a(this).addClass("fg-state-hover");
                                    a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id) + "_frozen").addClass("fg-state-hover")
                                },
                                function () {
                                    a(this).removeClass("fg-state-hover");
                                    a("#" + a.jgrid.jqID(this.id), "#" + a.jgrid.jqID(b.p.id) + "_frozen").removeClass("fg-state-hover")
                                }));
                                c = null
                            });
                ...
                if (this.grid && !0 === this.p.frozenColumns) {
                    ...
                    if (!0 === this.p.hoverrows) {
                        ...
                        function (c) {
                            ...
                            "fg-subgrid" !== a(b).attr("class") && a(b).addClass("fg-state-hover")
                        }).bind("mouseout",
                        function (c) {
                            b = a(c.target).closest("tr.jqgrow");
                            a(b).removeClass("fg-state-hover")
                        })
                    }
    ...
    a.extend(a.jgrid, {
        ...
        createModal: function (d, b, c, g, e, h, f) {
            ...
            k.className = "fg-widget fg-widget-content fg-corner-all fg-jqdialog";
            k.id = d.themodal;
            var n = document.createElement("div");
            n.className = "fg-jqdialog-titlebar fg-widget-header fg-corner-all fg-helper-clearfix";
            n.id = d.modalhead;
            a(n).append("<span class='fg-jqdialog-title'>" + c.caption + "</span>");
            var q = a("<a class='fg-jqdialog-titlebar-close fg-corner-all'></a>").hover(function () {
                q.addClass("fg-state-hover")
            },
            function () {
                q.removeClass("fg-state-hover")
            }).append("<span class='fg-icon fg-icon-closethick'></span>");
            a(n).append(q);
            l ? (k.dir = "rtl", a(".fg-jqdialog-title", n).css("float", "right"), a(".fg-jqdialog-titlebar-close", n).css("left", "0.3em")) : (k.dir = "ltr", a(".fg-jqdialog-title", n).css("float", "left"), a(".fg-jqdialog-titlebar-close", n).css("right", "0.3em"));
            var p = document.createElement("div");
            a(p).addClass("fg-jqdialog-content fg-widget-content").attr("id", d.modalcontent);
            a(p).append(b);
            k.appendChild(p);
            ...
            b.top = c.top + "px";
            a("a.fg-jqdialog-titlebar-close", n).click(function () {
            ...
            if (c.resize) if (a.fn.jqResize) a(k).append("<div class='jqResize fg-resizable-handle fg-resizable-se fg-icon fg-icon-gripsmall-diagonal-se'></div>"),
        ...
        viewModal: function (d, b) {
            b = a.extend({
                ...
                overlay: 10,
                modal: !1,
                overlayClass: "fg-widget-overlay",
        ...
        info_dialog: function (d, b, c, g) {
            ...
            d += "<a id='" + e.buttons[g].id + "' class='fm-button fg-state-default fg-corner-all'>" + e.buttons[g].text + "</a>";
            ...
            b += c ? "<div class='fg-widget-content fg-helper-clearfix' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button fg-state-default fg-corner-all'>" + c + "</a>" + d + "</div>" : "" !== d ? "<div class='fg-widget-content fg-helper-clearfix' style='text-align:" + e.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + d + "</div>" : "";
            b += "</div>";
            try {
    ...
    a.jgrid.extend({
            ...
            return this.each(function () {
                ...
                if (e.grid) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(s.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID(+e.p.id)));
                        ...
                        d = "<a id='" + h + "_search' class='fm-button fg-state-default fg-corner-all fm-button-icon-right fg-reset'><span class='fg-icon fg-icon-search'></span>" + b.Find + "</a>",
                        v = "<a id='" + h + "_reset' class='fm-button fg-state-default fg-corner-all fm-button-icon-left fg-search'><span class='fg-icon fg-icon-arrowreturnthick-1-w'></span>" + b.Reset + "</a>",
                        g = "",
                        m = "",
                        p,
                        q = !1,
                        y = -1;
                        b.showQuery && (g = "<a id='" + h + "_query' class='fm-button fg-state-default fg-corner-all fm-button-icon-left'><span class='fg-icon fg-icon-comment'></span>Query</a>");
                        ...
                        q = !1;
                        b.tmplNames && b.tmplNames.length && (q = !0, m = b.tmplLabel, m += "<select class='fg-template'>", m += "<option value='default'>Default</option>", a.each(b.tmplNames,
                        function (a, b) {
                            m += "<option value='" + a + "'>" + b + "</option>"
                        }), m += "</select>");
                        k = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + h + "_2'><tbody><tr><td colspan='2'><hr class='fg-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + k + "'>" + v + m + "</td><td class='EditButton' " + u + ">" + g + d + "</td></tr></tbody></table>";
                        h = a.jgrid.jqID(h);
                        a("#" + h).jqFilter({
                            columns: x,
                        ...
                        f.append(k);
                        q && b.tmplFilters && b.tmplFilters.length && a(".fg-template", f).bind("change",
                        function () {
                            var c = a(this).val();
                        ...
                        b.layer ? a.jgrid.createModal(s, f, b, "#gview_" + a.jgrid.jqID(e.p.id), a("#gbox_" + a.jgrid.jqID(e.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            ...
                            !1;
                            if (b.closeOnEscape && 27 === c.which) return a("#" + a.jgrid.jqID(s.modalhead)).find(".fg-jqdialog-titlebar-close").click(),
                            !1
                        });
                        ...
                        c(a("#" + h));
                        a(".fm-button:not(.fg-state-disabled)", f).hover(function () {
                            a(this).addClass("fg-state-hover")
                        },
                        function () {
                            a(this).removeClass("fg-state-hover")
            ...
            return this.each(function () {
                ...
                function h(c, e, n, f) {
                    ...
                    a(e.p.colModel).each(function (t) {
                        ...
                        if ("cb" !== k && "subgrid" !== k && !0 === this.editable && "rn" !== k) {
                            ...
                            a(r).addClass("FormElement"); -1 < a.inArray(this.edittype, ["text", "textarea", "password", "select"]) && a(r).addClass("fg-widget-content fg-corner-all");
                ...
                function s() {
                    ...
                    if (n[0] && !b[d.p.id].processing) {
                        ...
                        a("#sData", p + "_2").addClass("fg-state-active");
                        m = k.oper;
                        h = k.id;
                        ...
                        s = a.extend({
                            ...
                            complete: function (f, r) {
                                ...
                                a("#sData", p + "_2").removeClass("fg-state-active");
                                try {
                ...
                function u(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", p + "_2").addClass("fg-state-disabled") : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("fg-state-disabled") ? a("#pData", p + "_2").addClass("fg-state-disabled") : a("#pData", p + "_2").removeClass("fg-state-disabled");
                    b === d ? a("#nData", p + "_2").addClass("fg-state-disabled") : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("fg-state-disabled") ? a("#nData", p + "_2").addClass("fg-state-disabled") : a("#nData", p + "_2").removeClass("fg-state-disabled")
                }
                function x() {
                ...
                if (d.grid && z) {
                    ...
                    if (!1 !== n) {
                        ...
                        a(H).append(F);
                        A = a("<tr id='FormError' style='display:none'><td class='fg-state-error' colspan='" + 2 * C + "'></td></tr>");
                        A[0].rp = 0;
                        a(F).append(A);
                        ...
                        G = A ? "pData" : "nData";
                        h(z, d, F, C);
                        var n = "<a id='" + n + "' class='fm-button fg-state-default fg-corner-left'><span class='fg-icon fg-icon-triangle-1-w'></span></a>",
                        G = "<a id='" + G + "' class='fm-button fg-state-default fg-corner-right'><span class='fg-icon fg-icon-triangle-1-e'></span></a>",
                        J = "<a id='sData' class='fm-button fg-state-default fg-corner-all'>" + c.bSubmit + "</a>",
                        K = "<a id='cData' class='fm-button fg-state-default fg-corner-all'>" + c.bCancel + "</a>",
                        m = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + m + "_2'><tbody><tr><td colspan='2'><hr class='fg-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" + (A ? G + n : n + G) + "</td><td class='EditButton'>" + J + K + "</td></tr>" + ("<tr style='display:none' class='binfo'><td class='bottominfo' colspan='2'>" + b[d.p.id].bottominfo + "</td></tr>"),
                        m = m + "</tbody></table>";
                        if (0 < I) {
                            var L = [];
                            a.each(a(F)[0].rows,
                        ...
                        c.checkOnUpdate && (a("a.fg-jqdialog-titlebar-close span", "#" + a.jgrid.jqID(q.themodal)).removeClass("jqmClose"), a("a.fg-jqdialog-titlebar-close", "#" + a.jgrid.jqID(q.themodal)).unbind("click").click(function () {
                            if (!f()) return !1;
                        ...
                        c.saveicon = a.extend([!0, "left", "fg-icon-disk"], c.saveicon);
                        c.closeicon = a.extend([!0, "left", "fg-icon-close"], c.closeicon); !0 === c.saveicon[0] && a("#sData", p + "_2").addClass("right" === c.saveicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='fg-icon " + c.saveicon[2] + "'></span>"); !0 === c.closeicon[0] && a("#cData", p + "_2").addClass("right" === c.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='fg-icon " + c.closeicon[2] + "'></span>");
                        if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) J = "<a id='sNew' class='fm-button fg-state-default fg-corner-all' style='z-index:1002'>" + c.bYes + "</a>",
                        G = "<a id='nNew' class='fm-button fg-state-default fg-corner-all' style='z-index:1002'>" + c.bNo + "</a>",
                        K = "<a id='cNew' class='fm-button fg-state-default fg-corner-all' style='z-index:1002'>" + c.bExit + "</a>",
                        m = c.zIndex || 999,
                        m++,
                        a("<div class='" + c.overlayClass + " jqgrid-overlay confirm' style='z-index:" + m + ";display:none;'>&#160;</div><div class='confirm fg-widget-content fg-jqconfirm' style='z-index:" + (m + 1) + "'>" + c.saveData + "<br/><br/>" + J + G + K + "</div>").insertAfter("#" + g),
                        ...
                        a("#nData", p + "_2").click(function () {
                            ...
                            if (-1 !== b[0] && b[1][b[0] + 1]) {
                                ...
                                var e;
                                if (a.isFunction(c.onclickPgButtons) && (e = c.onclickPgButtons.call(d, "next", a("#" + g), b[1][b[0]]), void 0 !== e && !1 === e) || a("#" + a.jgrid.jqID(b[1][b[0] + 1])).hasClass("fg-state-disabled")) return !1;
                                w(b[1][b[0] + 1], d, g);
                        ...
                        a("#pData", p + "_2").click(function () {
                            ...
                            if (-1 !== b[0] && b[1][b[0] - 1]) {
                                ...
                                var e;
                                if (a.isFunction(c.onclickPgButtons) && (e = c.onclickPgButtons.call(d, "prev", a("#" + g), b[1][b[0]]), void 0 !== e && !1 === e) || a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass("fg-state-disabled")) return !1;
                                w(b[1][b[0] - 1], d, g);
                                a(d).jqGrid("setSelection", b[1][b[0] - 1]);
            ...
            return this.each(function () {
                function e() {
                    !0 !== b[r.p.id].closeOnEscape && !0 !== b[r.p.id].navkeys[0] || setTimeout(function () {
                        a(".fg-jqdialog-titlebar-close", "#" + a.jgrid.jqID(v.modalhead)).focus()
                    },
                        0)
                }
                function h(b, d, e, f) {
                    ...
                    s = !1,
                    t,
                    u = "<td class='CaptionTD form-view-label fg-widget-content' width='" + c.labelswidth + "'>&#160;</td><td class='DataTD form-view-data fg-helper-reset fg-widget-content'>&#160;</td>",
                    y = "",
                    ...
                    x,
                    D;
                    for (t = 1; t <= f; t++) y += 1 === t ? u : "<td class='CaptionTD form-view-label fg-widget-content'>&#160;</td><td class='DataTD form-view-data fg-widget-content'>&#160;</td>";
                    a(d.p.colModel).each(function () {
                ...
                function t(b, c) {
                    var d = c[1].length - 1;
                    0 === b ? a("#pData", "#" + u + "_2").addClass("fg-state-disabled") : void 0 !== c[1][b - 1] && a("#" + a.jgrid.jqID(c[1][b - 1])).hasClass("fg-state-disabled") ? a("#pData", u + "_2").addClass("fg-state-disabled") : a("#pData", "#" + u + "_2").removeClass("fg-state-disabled");
                    b === d ? a("#nData", "#" + u + "_2").addClass("fg-state-disabled") : void 0 !== c[1][b + 1] && a("#" + a.jgrid.jqID(c[1][b + 1])).hasClass("fg-state-disabled") ? a("#nData", u + "_2").addClass("fg-state-disabled") : a("#nData", "#" + u + "_2").removeClass("fg-state-disabled")
                }
                function s() {
                ...
                if (r.grid && z) {
                    ...
                    if (!1 !== m) {
                        ...
                        g = "<a id='" + (d ? "nData" : "pData") + "' class='fm-button fg-state-default fg-corner-left'><span class='fg-icon fg-icon-triangle-1-w'></span></a>";
                        m = "<a id='" + (d ? "pData" : "nData") + "' class='fm-button fg-state-default fg-corner-right'><span class='fg-icon fg-icon-triangle-1-e'></span></a>";
                        y = "<a id='cData' class='fm-button fg-state-default fg-corner-all'>" + c.bClose + "</a>";
                        if (0 < q) {
                            var E = [];
                            a.each(a(A)[0].rows,
                            function (a, b) {
                        ...
                        c.closeicon = a.extend([!0, "left", "fg-icon-close"], c.closeicon); !0 === c.closeicon[0] && a("#cData", "#" + u + "_2").addClass("right" === c.closeicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='fg-icon " + c.closeicon[2] + "'></span>");
                        ...
                        a(".fm-button:not(.fg-state-disabled)", "#" + u + "_2").hover(function () {
                            a(this).addClass("fg-state-hover")
                        },
                        function () {
                            a(this).removeClass("fg-state-hover")
            ...
            return this.each(function () {
                ...
                if (e.grid && z) {
                    ...
                    if (void 0 !== a("#" + a.jgrid.jqID(m.themodal))[0]) {
                        ...
                        a("#DelError", "#" + k).hide(); !0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + k).removeClass("fg-state-active"));
                        ...
                        g = g + "<tr id='DelError' style='display:none'><td class='fg-state-error'></td></tr>",
                        ...
                        g = g + "</tbody></table></div>",
                        g = g + ("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" + k + "_2'><tbody><tr><td><hr class='fg-widget-content' style='margin:1px'/></td></tr><tr><td class='DelButton EditButton'>" + ("<a id='dData' class='fm-button fg-state-default fg-corner-all'>" + c.bSubmit + "</a>") + "&#160;" + ("<a id='eData' class='fm-button fg-state-default fg-corner-all'>" + c.bCancel + "</a>") + "</td></tr></tbody></table>");
                        ...
                        c.delicon = a.extend([!0, "left", "fg-icon-scissors"], b[e.p.id].delicon);
                        c.cancelicon = a.extend([!0, "left", "fg-icon-cancel"], b[e.p.id].cancelicon); !0 === c.delicon[0] && a("#dData", "#" + k + "_2").addClass("right" === c.delicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='fg-icon " + c.delicon[2] + "'></span>"); !0 === c.cancelicon[0] && a("#eData", "#" + k + "_2").addClass("right" === c.cancelicon[1] ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='fg-icon " + c.cancelicon[2] + "'></span>");
                        a("#dData", "#" + k + "_2").click(function () {
                            ...
                            if (f[0] && !b[e.p.id].processing) {
                                ...
                                u[x] = h.join();
                                a(this).addClass("fg-state-active");
                                g = a.extend({
                                    ...
                                    complete: function (d, g) {
                                        ...
                                        a("#dData", "#" + k + "_2").removeClass("fg-state-active");
                    ...
                    w && b[e.p.id].afterShowForm.call(e, a("#" + k)); !0 === b[e.p.id].closeOnEscape && setTimeout(function () {
                        a(".fg-jqdialog-titlebar-close", "#" + a.jgrid.jqID(m.modalhead)).focus()
                    },
                    0)
                }
            })
        ...
        navGrid: function (b, c, e, h, w, t, s) {
            c = a.extend({
                edit: !0,
                editicon: "fg-icon-pencil",
                add: !0,
                addicon: "fg-icon-plus",
                del: !0,
                delicon: "fg-icon-trash",
                search: !0,
                searchicon: "fg-icon-search",
                refresh: !0,
                refreshicon: "fg-icon-refresh",
                refreshstate: "firstpage",
                view: !1,
                viewicon: "fg-icon-document",
                position: "left",
                closeOnEscape: !0,
                beforeRefresh: null,
                afterRefresh: null,
            ...
            return this.each(function () {
                if (!this.nav) {
                    ...
                    if (f.grid && "string" === typeof b) {
                        ...
                        var u = 1,
                        x, d = function () {
                            a(this).hasClass("fg-state-disabled") || a(this).addClass("fg-state-hover")
                        },
                        v = function () {
                            a(this).removeClass("fg-state-hover")
                        };
                        ...
                        for (x = 0; x < u; x++) {
                            var g = a("<table cellspacing='0' cellpadding='0' border='0' class='fg-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                            m,
                            p;
                            ...
                            c.add && (h = h || {},
                            k = a("<td class='fg-pg-button fg-corner-all'></td>"), a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.addtitle || "",
                                id: h.id || "add_" + p
                            }).click(function () {
                                a(this).hasClass("fg-state-disabled") || (a.isFunction(c.addfunc) ? c.addfunc.call(f) : a(f).jqGrid("editGridRow", "new", h));
                                return !1
                            }).hover(d, v), k = null);
                            c.edit && (k = a("<td class='fg-pg-button fg-corner-all'></td>"), e = e || {},
                            a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.edittitle || "",
                                id: e.id || "edit_" + p
                            }).click(function () {
                                if (!a(this).hasClass("fg-state-disabled")) {
                                    var b = f.p.selrow;
                            ...
                            c.view && (k = a("<td class='fg-pg-button fg-corner-all'></td>"), s = s || {},
                            a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.viewtitle || "",
                                id: s.id || "view_" + p
                            }).click(function () {
                                if (!a(this).hasClass("fg-state-disabled")) {
                            ...
                            c.del && (k = a("<td class='fg-pg-button fg-corner-all'></td>"), w = w || {},
                            a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.deltitle || "",
                                id: w.id || "del_" + p
                            }).click(function () {
                                if (!a(this).hasClass("fg-state-disabled")) {
                                ...
                                return !1
                            }).hover(d, v), k = null); (c.add || c.edit || c.del || c.view) && a("tr", g).append("<td class='fg-pg-button fg-state-disabled' style='width:4px;'><span class='fg-separator'></span></td>");
                            c.search && (k = a("<td class='fg-pg-button fg-corner-all'></td>"), t = t || {},
                            a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                                title: c.searchtitle || "",
                                id: t.id || "search_" + p
                            }).click(function () {
                                a(this).hasClass("fg-state-disabled") || (a.isFunction(c.searchfunc) ? c.searchfunc.call(f, t) : a(f).jqGrid("searchGrid", t));
                                return !1
                            }).hover(d, v), t.showOnLoad && !0 === t.showOnLoad && a(k, g).click(), k = null);
                            c.refresh && (k = a("<td class='fg-pg-button fg-corner-all'></td>"), a(k).append("<div class='fg-pg-div'><span class='fg-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", g).append(k), a(k, g).attr({
                            ...
                            k = a(".fg-jqgrid").css("font-size") || "11px";
                            a("body").append("<div id='testpg2' class='fg-jqgrid fg-widget fg-widget-content' style='font-size:" + k + ";visibility:hidden;' ></div>");
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    if (e && (!c.id || void 0 === a("#" + a.jgrid.jqID(c.id), e)[0])) {
                        var w = a("<td></td>");
                        "NONE" === c.buttonicon.toString().toUpperCase() ? a(w).addClass("fg-pg-button fg-corner-all").append("<div class='fg-pg-div'>" + c.caption + "</div>") : a(w).addClass("fg-pg-button fg-corner-all").append("<div class='fg-pg-div'><span class='fg-icon " + c.buttonicon + "'></span>" + c.caption + "</div>");
                        ...
                        a(w, e).attr("title", c.title || "").click(function (b) {
                            a(this).hasClass("fg-state-disabled") || a.isFunction(c.onClickButton) && c.onClickButton.call(h, b);
                            return !1
                        }).hover(function () {
                            a(this).hasClass("fg-state-disabled") || a(this).addClass("fg-state-hover")
                        },
        ...
        navSeparatorAdd: function (b, c) {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    var e = a(".navtable", b)[0];
                    if (e) {
                        var h = "<td class='fg-pg-button fg-state-disabled' style='width:4px;'><span class='" + c.sepclass + "'></span>" + c.sepcontent + "</td>";
        ...
        return this.each(function () {
            if (!this.filter) {
                ...
                if (q) {
                    ...
                    this.p.showQuery && a(this).append("<table class='queryresult fg-widget fg-widget-content' style='display:block;max-width:440px;border:0px none;' dir='" + this.p.direction + "'><tbody><tr><td class='query'></td></tr></tbody></table>");
                    var u = function (g, l) {
                        var b = [!0, ""],
                    ...
                    this.createTableForGroup = function (g, l) {
                        var b = this,
                        c, m = a("<table class='group fg-widget fg-widget-content' style='border:0px none;'><tbody></tbody></table>"),
                        e = "left";
                        "rtl" === this.p.direction && (e = "right", m.attr("dir", "rtl"));
                        null === l && m.append("<tr class='error' style='display:none;'><th colspan='5' class='fg-state-error' align='" + e + "'></th></tr>");
                        var h = a("<tr></tr>");
                        m.append(h);
                        ...
                        e.append(h);
                        if (!0 === this.p.ruleButtons) {
                            var h = a("<input type='button' value='+' title='Add rule' class='add-rule fg-add'/>"),
                            f;
                            h.bind("click",
                            function () {
                    ...
                    this.createTableRowForRule = function (g, l) {
                        ...
                        d = a("<td></td>");
                        m.append(d); !0 === this.p.ruleButtons && (p = a("<input type='button' value='-' title='Delete rule' class='delete-rule fg-del'/>"), d.append(p), p.bind("click",
                        function () {
                    ...
                    this.hideError = function () {
                        a("th.fg-state-error", this).html("");
                        a("tr.error", this).hide()
                    };
                    this.showError = function () {
                        a("th.fg-state-error", this).html(this.p.errmsg);
    ...
    a.jgrid.extend({
                    ...
                    a.ajax(a.extend({
                        ...
                        error: function (b, e, g) {
                            ...
                            if (a.isFunction(f.errorfunc)) f.errorfunc.call(d, c, b, e, g);
                                ...
                                try {
                                    a.jgrid.info_dialog(a.jgrid.errors.errcap, '<div class="fg-state-error">' + b + "</div>", a.jgrid.edit.bClose, {
                                        buttonalign: "right"
                                    })
                                } catch (h) {
                                    alert(b)
        ...
        addRow: function (c) {
            ...
            return this.each(function () {
                if (this.grid) {
                    ...
                    }), a(e).jqGrid("addRowData", c.rowID, c.initdata, c.position), c.rowID = e.p.idPrefix + c.rowID, a("#" + a.jgrid.jqID(c.rowID), "#" + a.jgrid.jqID(e.p.id)).addClass("jqgrid-new-row"), c.useFormatter ? a("#" + a.jgrid.jqID(c.rowID) + " .fg-inline-edit", "#" + a.jgrid.jqID(e.p.id)).click() : (b = e.p.prmNames, c.addRowParams.extraparam[b.oper] = b.addoper, a(e).jqGrid("editRow", c.rowID, c.addRowParams), a(e).jqGrid("setSelection", c.rowID)))
                }
            })
        },
        inlineNav: function (c, e) {
            e = a.extend(!0, {
                ...
                addicon: "fg-icon-plus",
                save: !0,
                saveicon: "fg-icon-disk",
                cancel: !0,
                cancelicon: "fg-icon-cancel",
                addParams: {
                    addRowParams: {
                        extraparam: {}
                    }
                ...
                if (this.grid) {
                    ...
                    e.add && a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function () {
                            ...
                            e.addParams.useFormatter || (a("#" + h + "_ilsave").removeClass("fg-state-disabled"), a("#" + h + "_ilcancel").removeClass("fg-state-disabled"), a("#" + h + "_iladd").addClass("fg-state-disabled"), a("#" + h + "_iledit").addClass("fg-state-disabled"))
                        }
                    });
                    e.edit && a(b).jqGrid("navButtonAdd", c, {
                        ...
                        onClickButton: function () {
                            ...
                            c ? (a(b).jqGrid("editRow", c, e.editParams), a("#" + h + "_ilsave").removeClass("fg-state-disabled"), a("#" + h + "_ilcancel").removeClass("fg-state-disabled"), a("#" + h + "_iladd").addClass("fg-state-disabled"), a("#" + h + "_iledit").addClass("fg-state-disabled")) : (a.jgrid.viewModal("#alertmod", {
                                gbox: "#gbox_" + h,
                                jqm: !0
                            }), a("#jqg_alrt").focus())
                        }
                    ...
                    }), a("#" + h + "_ilsave").addClass("fg-state-disabled"));
                    ...
                    }), a("#" + h + "_ilcancel").addClass("fg-state-disabled")); !0 === e.restoreAfterSelect && (l = a.isFunction(b.p.beforeSelectRow) ? b.p.beforeSelectRow : !1, b.p.beforeSelectRow = function (c, f) {
                        var h = !0;
        ...
        showAddEditButtons: function () {
            return this.each(function () {
                if (this.grid) {
                    ...
                    a("#" + c + "_ilsave").addClass("fg-state-disabled");
                    a("#" + c + "_ilcancel").addClass("fg-state-disabled");
                    a("#" + c + "_iladd").removeClass("fg-state-disabled");
                    a("#" + c + "_iledit").removeClass("fg-state-disabled")
                }
            })
        }
    })
            ...
            return this.each(function () {
                ...
                if (c.grid && !0 === c.p.cellEdit) {
                    ...
                    if ("subgrid" !== g && "cb" !== g && "rn" !== g) {
                        ...
                        if (!0 !== k.editable || !0 !== a || h.hasClass("not-editable-cell")) 0 <= parseInt(c.p.iCol, 10) && 0 <= parseInt(c.p.iRow, 10) && (b("td:eq(" + c.p.iCol + ")", c.rows[c.p.iRow]).removeClass("edit-cell fg-state-highlight"), b(c.rows[c.p.iRow]).removeClass("selected-row fg-state-hover")),
                        h.addClass("edit-cell fg-state-highlight"),
                        b(c.rows[d]).addClass("selected-row fg-state-hover"),
                        ...
                        b.isFunction(c.p.onSelectCell) && c.p.onSelectCell.call(c, c.rows[d].id, g, e, d, f);
                            ...
                            0 <= parseInt(c.p.iCol, 10) && 0 <= parseInt(c.p.iRow, 10) && (b("td:eq(" + c.p.iCol + ")", c.rows[c.p.iRow]).removeClass("edit-cell fg-state-highlight"), b(c.rows[c.p.iRow]).removeClass("selected-row fg-state-hover"));
                            b(h).addClass("edit-cell fg-state-highlight");
                            b(c.rows[d]).addClass("selected-row fg-state-hover");
                            try {
                            ...
                            function (a) {
                                27 === a.keyCode && (0 < b("input.hasDatepicker", h).length ? b(".fg-datepicker").is(":hidden") ? b(c).jqGrid("restoreCell", d, f) : b("input.hasDatepicker", h).datepicker("hide") : b(c).jqGrid("restoreCell", d, f));
    ...
    b.jgrid.extend({
        setSubGrid: function () {
            return this.each(function () {
                ...
                this.p.subGridOptions = b.extend({
                    plusicon: "fg-icon-plus",
                    minusicon: "fg-icon-minus",
                    openicon: "fg-icon-carat-1-sw",
                    expandOnLoad: !1,
                    delayOnLoad: 50,
                    selectOnExpand: !1,
                    selectOnCollapse: !1,
        ...
        addSubGridCell: function (b, c) {
            ...
            return '<td role="gridcell" aria-describedby="' + n + '_subgrid" class="fg-sgcollapsed sgcollapsed" ' + a + "><a style='cursor:pointer;'><span class='fg-icon " + p + "'></span></a></td>"
        },
            ...
            return this.each(function () {
                ...
                if (a.grid) {
                    ...
                    n = function (c, d) {
                        ...
                        k = b("<tr></tr>");
                        for (f = 0; f < a.p.subGridModel[0].name.length; f++) h = b("<th class='fg-state-default fg-th-subgrid fg-th-column fg-th-" + a.p.direction + "'></th>"),
                        ...
                        c && (e = a.p.xmlReader.subgrid, b(e.root + " " + e.row, c).each(function () {
                            k = b("<tr class='fg-widget-content fg-subtblcell'></tr>");
                    ...
                    r = function (c, d) {
                        ...
                        if (c && (g = a.p.jsonReader.subgrid, h = b.jgrid.getAccessor(c, g.root), void 0 !== h)) for (f = 0; f < h.length; f++) {
                            e = h[f];
                            l = b("<tr class='fg-widget-content fg-subtblcell'></tr>");
                    ...
                    function () {
                        ...
                        if (b(this).hasClass("sgcollapsed")) {
                            m = a.p.id;
                            e = c.id;
                            if (!0 === a.p.subGridOptions.reloadOnExpand || !1 === a.p.subGridOptions.reloadOnExpand && !b(l).hasClass("fg-subgrid")) {
                                ...
                                if (!1 === g) return !1;
                                b(c).after("<tr role='row' class='fg-subgrid'>" + s + "<td class='fg-widget-content subgrid-cell'><span class='fg-icon " + a.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(a.p.colNames.length - 1 - t, 10) + "' class='fg-widget-content subgrid-data'><div id=" + m + "_" + e + " class='tablediv'></div></td></tr>");
                            ...
                            b(this).html("<a style='cursor:pointer;'><span class='fg-icon " + a.p.subGridOptions.minusicon + "'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded");
                            ...
                            if (!1 === g) return !1; !0 === a.p.subGridOptions.reloadOnExpand ? b(l).remove(".fg-subgrid") : b(l).hasClass("fg-subgrid") && b(l).hide();
                            b(this).html("<a style='cursor:pointer;'><span class='fg-icon " + a.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed");
        ...
        groupingRender: function (b, k, a, c) {
            return this.each(function () {
                ...
                function (g, l) {
                    ...
                    r = q + "_" + g;
                    p = "<span style='cursor:pointer;' class='fg-icon " + n + "' onclick=\"jQuery('#" + d.jgrid.jqID(e.p.id) + "').jqGrid('groupingToggle','" + r + "');return false;\"></span>";
                    try {
                    ...
                    if (z - 1 === l.idx) {
                        ...
                        if ("header" !== f.groupSummaryPos[l.idx]) {
                            ...
                            for (s = 0; s < x; s++) A[s] && (u = "", f.groupCollapse && !f.showSummaryOnHide && (u = ' style="display:none;"'), h += "<tr" + u + ' jqfootlevel="' + (l.idx - s) + '" role="row" class="fg-widget-content jqfoot fg-row-' + e.p.direction + '">', h += m(g, s, f.groups, 0), h += "</tr>");
                            x = w
                        }
                    }
                });
    ...
    d.jgrid.extend({
        setTreeNode: function (b, c) {
            return this.each(function () {
                ...
                q += "<div style='" + ("rtl" === a.p.direction ? "right:" : "left:") + 18 * p + "px;' class='fg-icon ",
        ...
        setTreeGrid: function () {
            return this.each(function () {
                ...
                if (b.p.treeGrid) {
                    ...
                    b.p.rowList = [];
                    b.p.expColInd = 0;
                    a = "fg-icon-triangle-1-" + ("rtl" === b.p.direction ? "w" : "e");
                    b.p.treeIcons = d.extend({
                        plus: a,
                        minus: "fg-icon-triangle-1-s",
                        leaf: "fg-icon-radio-off"
                    },
                    b.p.treeIcons || {});
    ...
    b.jgrid.extend({
        sortableColumns: function (a) {
            return this.each(function () {
                ...
                e = {
                    ...
                    placeholder: {
                        element: function (a) {
                            return b(document.createElement(a[0].nodeName)).addClass(a[0].className + " fg-sortable-placeholder fg-state-highlight").removeClass("fg-sortable-helper")[0]
                        },
                        update: function (b, a) {
        ...
        gridDnD: function (a) {
            return this.each(function () {
                function d() {
                    var a = b.data(c, "dnd");
                    b("tr.jqgrow:not(.fg-draggable)", c).draggable(b.isFunction(a.drag) ? a.drag.call(b(c), a) : a.drag)
                }
                var c = this,
                e, g;
                if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable) if (void 0 === b("#jqgrid_dnd")[0] && b("body").append("<table id='jqgrid_dnd' class='fg-jqgrid-dnd'></table>"), "string" === typeof a && "updateDnD" === a && !0 === c.p.jqgdnd) d();
                else if (a = b.extend({
                        drag: function (a) {
                        return b.extend({
                        start: function (e, d) {
                                ...
                                d.helper.addClass("fg-state-highlight");
                    ...
                    accept: function (a) {
                                ...
                                a = b(a).closest("table.fg-jqgrid-btable");
                    ...
                    ondrop: null,
                    drop_opts: {
                    activeClass: "fg-state-active",
                    hoverClass: "fg-state-hover"
                },
                    drag_opts: {
                    revert: "invalid",
                    helper: "clone",
            ...
            return this.each(function () {
                ...
                a || {}), a.alsoResize ? (a._alsoResize_ = a.alsoResize, delete a.alsoResize) : a._alsoResize_ = !1, a.stop && b.isFunction(a.stop) ? (a._stop_ = a.stop, delete a.stop) : a._stop_ = !1, a.stop = function (e, g) {
                    b(d).jqGrid("setGridParam", {
                        height: b("#gview_" + c + " .fg-jqgrid-bdiv").height()
                    });
                    b(d).jqGrid("setGridWidth", g.size.width, a.shrinkToFit);
                    a._stop_ && a._stop_.call(d, e, g)
                },
                a.alsoResize = a._alsoResize_ ? eval("(" + ("{'#gview_" + c + " .fg-jqgrid-bdiv':true,'" + a._alsoResize_ + "':true}") + ")") : b(".fg-jqgrid-bdiv", "#gview_" + c), delete a._alsoResize_, b("#gbox_" + c).resizable(a))
            })
        }
    })
})(jQuery);